...
\newcommand{\thedate}{2014/10/21}
\date{\thedate}
\conference{Lab meeting}{Inoue Lab meeting}
\title[Algebraic Modeling of the Multi-Scale Dynamics of BRNs]%
  {Algebraic Modeling of the Multi-Scale Dynamics\\of Biological Regulatory Networks}
